...
test("4.5-Version und Cache-Version sind synchron", async () => {
  ...
  assert.match(worker, /APP_VERSION\s*=\s*"4\.5\.0"/);
  assert.match(worker, /v4-5-0/);
  assert.equal(JSON.parse(metadata).appVersion, "4.5.0");
});
