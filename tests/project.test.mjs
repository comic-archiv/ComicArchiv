...
test("Version 4.5.1, Datenformat 9 und Datenbank 5 sind durchgängig verdrahtet", async () => {
  ...
  assert.equal(versionData.appVersion, "4.5.1");
  ...
  assert.match(serviceWorker, /const APP_VERSION = "4\.5\.1"/);
});
